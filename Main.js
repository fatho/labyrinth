...
Elm.Game.make = function (_elm) {
   ...
   var updateCurrentPlayer = F2(function (newpl,
   board) {
      return function () {
         var _ = board.players;
         var ps = function () {
            ...
            {case "::": return _._1;}
            _U.badCase($moduleName,
            "on line 272, column 17 to 30");
         }();
         return _U.replace([["players"
                            ,A2($List._op["::"],newpl,ps)]],
         board);
      }();
   });
   var hasWon = function (player) {
      return _U.eq(player.targets,
      _L.fromArray([])) && _U.eq(player.position,
      player.home);
   };
   var currentPlayer = function (board) {
      return $List.head(board.players);
   };
   var processTarget = function (board) {
      return function () {
         var curPlayer = currentPlayer(board);
         return function () {
            var _v3 = A2($Dict.get,
            curPlayer.position,
            board.pieces);
            ...
            {case "Just":
               return function () {
                    var _v5 = currentPlayer(board).targets;
                    switch (_v5.ctor)
                    {case "::":
                       return _U.eq(_v3._0.treasure,
                         $Maybe.Just(_v5._0)) ? updateCurrentPlayer(_U.replace([["targets"
                                                                                ,_v5._1]],
                         curPlayer))(_U.replace([["collectedTreasures"
                                                 ,A2($Set.insert,
                                                 _v5._0,
                                                 board.collectedTreasures)]],
                         board)) : board;
                       case "[]": return board;}
                    _U.badCase($moduleName,
                    "between lines 299 and 305");
                 }();
   ...
   var nextPlayer = function (board) {
      return function () {
         var _raw = board.players,
         $ = _raw.ctor === "::" ? _raw : _U.badCase($moduleName,
         "on line 260, column 34 to 47"),
         p = $._0,
         ps = $._1;
         return _U.replace([["players"
                            ,A2($Basics._op["++"],
      ...
      return function () {
         ...
         {case "_Tuple2":
            return _U.eq(A2($Basics._op["%"],
              ...
              1);}
         _U.badCase($moduleName,
         "on line 256, column 22 to 48");
      }();
   };
   var movableIndices = function (len) {
      return A2($List.map,
      function (p) {
         return p * 2 + 1;
      },
      _L.range(0,(len / 2 | 0) - 1));
   };
   var movableRows = function (board) {
      return movableIndices(board.height);
   };
   var movableCols = function (board) {
      return movableIndices(board.width);
   };
   var rank = function (p) {
      return function () {
         var remaining = $List.length(p.targets);
         return _U.eq(remaining,
         0) && _U.eq(p.position,
         p.home) ? 0 : remaining + 1;
      }();
   };
   var playerHomes = _L.fromArray([{ctor: "_Tuple2"
                                   ,_0: 0
                                   ,_1: 0}
                                  ...
                                  ,{ctor: "_Tuple2"
                                   ,_0: 6
                                   ,_1: 0}]);
   var playerColors = _L.fromArray([$Color.red
                                   ,$Color.blue
                                   ,$Color.green
                                   ,$Color.yellow]);
   var junction = function (t) {
      return {_: {}
             ,bottom: true
             ,left: true
             ,right: true
   ...
   var isOpenOn = F2(function (piece,
   dir) {
      return function () {
         switch (dir.ctor)
         {case "East":
            return piece.right;
            case "North": return piece.top;
            case "South":
            return piece.bottom;
            case "West": return piece.left;}
         _U.badCase($moduleName,
         "between lines 113 and 117");
      }();
   });
   var orientationAngle = function (o) {
      return function () {
         switch (o.ctor)
         {case "East":
            return $Basics.degrees(90);
            case "North": return 0;
            case "South":
            return $Basics.degrees(180);
            case "West":
            return $Basics.degrees(270);}
         _U.badCase($moduleName,
         "between lines 105 and 109");
      }();
   };
   var rotate = F2(function (dir,
   blk) {
      return function () {
         switch (dir.ctor)
         {case "CCW":
            return _U.replace([["right"
                               ,blk.bottom]
                              ,["bottom",blk.left]
                              ,["left",blk.top]
                              ,["top",blk.right]],
   ...
   var rotateFreePiece = F2(function (rot,
   board) {
      return _U.replace([["freePiece"
                         ,A2(rotate,
                         rot,
                         board.freePiece)]],
      board);
   ...
   var CCW = {ctor: "CCW"};
   var CW = {ctor: "CW"};
   var rotateTo = F2(function (o,
   p) {
      return function () {
         switch (o.ctor)
         {case "East": return A2(rotate,
              CW,
              p);
            case "North": return p;
            case "South":
            return rotate(CW)(A2(rotate,
              CW,
              p));
            case "West": return A2(rotate,
              CCW,
              p);}
         _U.badCase($moduleName,
   ...
   var East = {ctor: "East"};
   var isHorizontal = function (o) {
      return _U.eq(o,
      West) || _U.eq(o,East);
   };
   var isVertical = function ($) {
      return $Basics.not(isHorizontal($));
   };
   var North = {ctor: "North"};
   var orientationGen = function () {
      var orientations = $Array.fromList(_L.fromArray([North
                                                      ,East
                                                      ,South
                                                      ,West]));
   ...
   var rotateRandom = F2(function (p,
   seed) {
      return function () {
   ...
   var moveTo = F2(function (side,
   board) {
      return function () {
         var player = currentPlayer(board);
         var updplayer = _U.replace([["position"
                                     ,A2(to,player.position,side)]],
         player);
         var playerPiece = A2($Dict.get,
         player.position,
         board.pieces);
         var adjacentPiece = A2($Dict.get,
         A2(to,player.position,side),
         board.pieces);
         ...
         return canMove ? A2(updateCurrentPlayer,
         updplayer,
         board) : board;
      }();
   });
   var shift = F2(function (shiftCmd,
   board) {
      return function () {
         var shifted = function (_v27) {
            return function () {
               switch (_v27.ctor)
               {case "_Tuple2":
                  return isHorizontal(shiftCmd.side) ? _U.eq(_v27._1,
                    shiftCmd.index) : _U.eq(_v27._0,
                    shiftCmd.index);}
               _U.badCase($moduleName,
         ...
         removed = $._0,
         rest = $._1;
         var shiftEdgePos = function (side) {
            return function () {
               switch (side.ctor)
               {case "East":
                  return {ctor: "_Tuple2"
         ...
         var shiftedOut = shiftEdgePos(shiftCmd.side);
         var newFree = A2($Util.unsafeGet,
         shiftedOut,
         removed);
         var shiftDir = opposite(shiftCmd.side);
         var shiftedIn = shiftEdgePos(shiftDir);
         var doShift = F2(function (pos,
         dict) {
            return _U.eq(pos,
            shiftedOut) ? dict : A3($Dict.insert,
            A2(to,pos,shiftDir),
            A2($Util.unsafeGet,pos,removed),
            dict);
         });
         var relocateToken = function (player) {
            return shifted(player.position) ? _U.replace([["position"
                                                          ,_U.eq(player.position,
                                                          shiftedOut) ? shiftedIn : A2(to,
                                                          player.position,
                                                          shiftDir)]],
            player) : player;
         };
         var shiftCoords = isHorizontal(shiftCmd.side) ? A2($List.map,
         function (i) {
            return {ctor: "_Tuple2"
                   ,_0: i
                   ,_1: shiftCmd.index};
         ...
         _L.range(0,
         board.width - 1)) : A2($List.map,
         function (i) {
            return {ctor: "_Tuple2"
                   ,_0: shiftCmd.index
                   ,_1: i};
         },
         _L.range(0,board.width - 1));
         var newBoard = A2($Dict.insert,
         shiftedIn,
         board.freePiece)(A3($List.foldl,
         doShift,
         rest,
         shiftCoords));
   ...
   var initialPieces = _L.fromArray([_L.fromArray([A2(curve,
                                                  East,
                                                  $Maybe.Nothing)
                                                  ,A2(tjunction,
                                                  South,
                                    ...
                                    ,_L.fromArray([A2(curve,
                                                  ...
                                                  West,
                                                  $Maybe.Nothing)])]);
   var loosePieces = $List.concat(_L.fromArray([_L.fromArray([A2(curve,
                                                             North,
                                                             $Maybe.Nothing)
                                                             ,A2(tjunction,
                                                             North,
   ...
   players) {
      return function () {
         var $ = $Random$Array.shuffle(seed)($Array.fromList(loosePieces)),
         randomArr = $._0,
         seed$ = $._1;
         var _ = A2($Util.mapAccumL,
         rotateRandom,
         seed$)($Array.toList(randomArr));
         var freePiece = function () {
            switch (_.ctor)
            {case "_Tuple2":
               switch (_._0.ctor)
                 {case "::": return _._0._0;}
         ...
         var fixedPieces = $Dict.fromList($List.concat(A3($List.map2,
         prepareRow,
         _L.range(0,3),
         initialPieces)));
         var loosePieceCoords = $List.filter(function ($) {
         ...
         _L.range(0,6),
         _L.range(0,6)));
         var movablePieces = $Dict.fromList(A3($List.map2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         ...
         return {ctor: "_Tuple2"
                ,_0: {_: {}
                     ,collectedTreasures: $Set.empty
                     ,freePiece: freePiece
                     ,height: 7
                     ,lastShift: $Maybe.Nothing
                     ,pieces: A2($Dict.union,
                     fixedPieces,
                     movablePieces)
                     ,players: players
                     ,width: 7}
   ...
   var allTreasures = $Array.fromList($List.filterMap(function (_) {
      return _.treasure;
   })(A2($Basics._op["++"],
   $List.concat(initialPieces),
   loosePieces)));
   var initialPlayers = F2(function (seed,
   names) {
      return function () {
         var $ = A2($Random$Array.shuffle,
         seed,
         allTreasures),
         targets = $._0,
         seed$ = $._1;
         var targetsPerPlayer = $Array.length(targets) / $List.length(names) | 0;
         var targetsFor = function (idx) {
            return A3($Array.slice,
            idx * targetsPerPlayer,
            (idx + 1) * targetsPerPlayer,
            targets);
         };
         var mkPlayer = F4(function (name,
         col,
         home,
         idx) {
            return {_: {}
                   ...
                   ,name: name
                   ,position: home
                   ,targets: $Array.toList(targetsFor(idx))};
         });
         return {ctor: "_Tuple2"
                ,_0: A5($List.map4,
                mkPlayer,
   ...
   var newGame = F2(function (seed,
   playerNames) {
      return function () {
         var $ = A2(initialPlayers,
         seed,
         playerNames),
         players = $._0,
         s0 = $._1;
   ...
   _elm.Game.values = {_op: _op
                      ...
                      ,movableCols: movableCols
                      ,cellMovable: cellMovable
                      ,nextPlayer: nextPlayer
                      ,currentPlayer: currentPlayer
                      ,hasWon: hasWon
                      ,updateCurrentPlayer: updateCurrentPlayer
                      ,rotateFreePiece: rotateFreePiece
                      ,moveTo: moveTo
...
Elm.Main.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm),
   $Util = Elm.Util.make(_elm);
   var extractPlayerNames = $List.filterMap(function (c) {
      return _U.cmp($String.length(c.string),
      0) > 0 ? $Maybe.Just(c.string) : $Maybe.Nothing;
   });
   var moveCommands = $Signal.mergeMany(_L.fromArray([A2($Signal._op["<~"],
                                                     $Basics.always($Game.North),
                                                     $Util.keyPresses(function (_) {
                                                        return _.keyCode;
                                                     }($Keyboard$Keys.arrowUp)))
                                                     ,A2($Signal._op["<~"],
                                                     $Basics.always($Game.South),
                                                     $Util.keyPresses(function (_) {
                                                        return _.keyCode;
                                                     }($Keyboard$Keys.arrowDown)))
                                                     ,A2($Signal._op["<~"],
                                                     $Basics.always($Game.West),
                                                     $Util.keyPresses(function (_) {
                                                        return _.keyCode;
                                                     }($Keyboard$Keys.arrowRight)))
                                                     ,A2($Signal._op["<~"],
                                                     $Basics.always($Game.East),
                                                     $Util.keyPresses(function (_) {
                                                        return _.keyCode;
                                                     }($Keyboard$Keys.arrowLeft)))]));
   var playerNameChannels = A2($List.map,
   function (f) {
      return $Signal.channel($Graphics$Input$Field.noContent);
   },
   $Game.playerColors);
   var restartNewChannel = $Signal.channel({ctor: "_Tuple0"});
   var restartSameChannel = $Signal.channel({ctor: "_Tuple0"});
   var startGameChannel = $Signal.channel({ctor: "_Tuple0"});
   var freeRotateChannel = $Signal.channel($Game.CW);
   var shiftChannel = $Signal.channel({_: {}
                                      ,index: -1
                                      ,side: $Game.North});
   var viewAskPlayerNames = function (contents) {
      return function () {
         var startButton = _U.cmp($List.length(extractPlayerNames(contents)),
         2) > -1 ? A2($Graphics$Input.button,
         A2($Signal.send,
         startGameChannel,
         {ctor: "_Tuple0"}),
         "Start Game") : A2($Graphics$Element.spacer,
         0,
         40);
         var heading = A2($Graphics$Element.above,
         $Text.centered($Text.height(30)($Text.fromString("Participating Players"))),
         A2($Graphics$Element.spacer,
         0,
         20));
         var mkField = F3(function (idx,
         chan,
         content) {
         ...
         var fields = A2($Graphics$Element.flow,
         ...
         playerNameChannels,
         contents));
         var containerWidth = A2($Basics.max,
         $Basics.fst($Graphics$Element.sizeOf(fields)),
         $Basics.fst($Graphics$Element.sizeOf(heading)));
         var containerHeight = $Basics.snd($Graphics$Element.sizeOf(fields)) + 20;
         return A3($Graphics$Element.container,
         1200,
         810,
         $Graphics$Element.middle)(A2($Graphics$Element.above,
         ...
         A4($Graphics$Element.container,
         containerWidth,
         $Basics.snd($Graphics$Element.sizeOf(startButton)) + 2,
         $Graphics$Element.middle,
         startButton)));
      }();
   };
   var colorIndicator = F2(function (color,
   el) {
      return function () {
         var h = $Basics.snd($Graphics$Element.sizeOf(el));
         return A2($Graphics$Element.beside,
         A3($Graphics$Collage.collage,
         20,
         h,
         _L.fromArray([$Graphics$Collage.filled(color)(A2($Graphics$Collage.rect,
         10,
         $Basics.toFloat(h) * 0.9))])),
         el);
      }();
   });
   var viewPlayerList = function (players) {
      return function () {
         var headingNext = $Text.centered($Text.bold($Text.fromString("Next Players:")));
         var headingCur = $Text.centered($Text.bold($Text.fromString("Current Player:")));
         var displayNextPlayer = F2(function (i,
         p) {
            return colorIndicator(p.color)($Text.plainText(A2($Basics._op["++"],
            $Basics.toString(i),
            A2($Basics._op["++"],
            ". ",
            A2($Basics._op["++"],
            ...
            " (",
            A2($Basics._op["++"],
            $Basics.toString($List.length(p.targets)),
            " remaining)")))))));
         });
         var nextPlayers = $Graphics$Element.flow($Graphics$Element.down)(A3($List.map2,
         displayNextPlayer,
         _L.range(2,4),
         $List.tail(players)));
         var displayCurPlayer = function (p) {
            return colorIndicator(p.color)(A2($Graphics$Element.flow,
            $Graphics$Element.down,
            _L.fromArray([$Text.leftAligned($Text.fromString(A2($Basics._op["++"],
                         p.name,
                         A2($Basics._op["++"],
                         " (",
                         A2($Basics._op["++"],
                         ...
                         ,function () {
                            ...
                            {case "::":
                               return A2($Graphics$Element.flow,
                                 ...
                                 _L.fromArray([$Text.leftAligned($Text.fromString("Next target is: "))
                                              ,A2($Util.withClass,
                                              "hover_disclose",
                                              $Text.leftAligned($Text.fromString(_v0._0)))]));
                               case "[]":
         ...
         return A2($Graphics$Element.flow,
         $Graphics$Element.down,
         _L.fromArray([headingCur
                      ,displayCurPlayer($List.head(players))
                      ,headingNext
                      ,nextPlayers]));
      }();
   };
   var viewGameOver = function (_v3) {
      return function () {
         switch (_v3.ctor)
         {case "::": return function () {
                 ...
                 var buttonHeight = $Basics.snd($Graphics$Element.sizeOf(buttons)) + 20;
                 var heading = $Text.centered($Text.height(40)($Text.fromString("Game Over!")));
                 var headingHeight = $Basics.snd($Graphics$Element.sizeOf(heading)) + 20;
                 var displayEntry = F2(function (n,
                 player) {
                    return colorIndicator(player.color)($Text.leftAligned($Text.height(20)($Text.fromString(A2($Basics._op["++"],
                    $Basics.toString(n),
                    A2($Basics._op["++"],
                    ". ",
                    player.name))))));
                 });
                 var displayRanked = F3(function (n,
                 cur,
                 ps) {
                    return A2($List._op["::"],
                    A2(displayEntry,n,cur),
                    function () {
                       switch (ps.ctor)
                       {case "::":
                          return _U.eq($Game.rank(ps._0),
                            $Game.rank(cur)) ? A3(displayRanked,
                            n,
                            ps._0,
                            ps._1) : A3(displayRanked,
                            n + 1,
                            ps._0,
                            ps._1);
                          case "[]":
                 ...
                 _v3._0,
                 _v3._1));
                 var containerWidth = $List.maximum(_L.fromArray([$Basics.fst($Graphics$Element.sizeOf(heading))
                                                                 ,$Basics.fst($Graphics$Element.sizeOf(rankedList))
                                                                 ,$Basics.fst($Graphics$Element.sizeOf(buttons))]));
                 var listHeight = $Basics.snd($Graphics$Element.sizeOf(rankedList)) + 20;
                 return A3($Graphics$Element.container,
                 1200,
                 810,
                 $Graphics$Element.middle)(A2($Graphics$Element.above,
   ...
   var renderTreasure = function (t) {
      return $Graphics$Collage.toForm($Text.centered($Text.style(_U.replace([["color"
                                                                             ,$Color.lightGrey]
                                                                            ,["bold"
                                                                             ,true]],
      $Text.defaultStyle))($Text.fromString(t))));
   };
   var smallSize = 30;
   var pieceSize = 3 * smallSize;
   var boardRealSize = function (board) {
      return {_: {}
             ,height: board.height * pieceSize
             ,width: board.width * pieceSize};
   };
   var boardToCanvas = F2(function (board,
   _v10) {
      return function () {
         switch (_v10.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: $Basics.toFloat(_v10._0 - (board.width / 2 | 0)) * pieceSize
                   ,_1: $Basics.toFloat((board.height / 2 | 0) - _v10._1) * pieceSize};}
         _U.badCase($moduleName,
         "between lines 102 and 103");
      }();
   });
   var rotateButtonArrow = F2(function (angularDir,
   enabled) {
      return function () {
         var enabledStr = enabled ? "enabled" : "disabled";
         var dirStr = $Basics.toString(angularDir);
         var imgSrc = A2($Basics._op["++"],
         "rotate",
         A2($Basics._op["++"],
         dirStr,
         A2($Basics._op["++"],
   ...
   var renderPiece = F2(function (movable,
   blk) {
      return function () {
         var keepIfOpen = function (_v14) {
            return function () {
               switch (_v14.ctor)
               {case "_Tuple2":
                  return _v14._0 ? $Maybe.Just(_v14._1) : $Maybe.Nothing;}
               _U.badCase($moduleName,
               "on line 89, column 29 to 60");
            }();
         };
         var sides = A3($List.map2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         }),
         _L.fromArray([blk.left
                      ,blk.top
                      ,blk.right
                      ,blk.bottom]),
         _L.fromArray([{ctor: "_Tuple2"
                      ...
                      ,{ctor: "_Tuple2"
                       ,_0: 0
                       ,_1: -0.75 * smallSize}]));
         var outline = $Graphics$Collage.outlined($Graphics$Collage.solid($Color.brown))($Graphics$Collage.square(pieceSize));
         var way = $Graphics$Collage.filled($Color.lightBrown)($Graphics$Collage.square(1.5 * smallSize));
         var wayFromCoords = $List.map(A2($Basics.flip,
         $Graphics$Collage.move,
         way));
         var wall = (movable ? $Graphics$Collage.filled($Color.darkBrown) : $Graphics$Collage.filled(A3($Color.rgb,
         120,
         68,
         33)))($Graphics$Collage.square(pieceSize));
         return $Graphics$Collage.group(A2($Basics._op["++"],
         _L.fromArray([wall,way]),
         A2($Basics._op["++"],
         wayFromCoords(A2($List.filterMap,
         keepIfOpen,
         sides)),
         _L.fromArray([outline]))));
      }();
   });
   ...
   var playerToken = function (col) {
      return function () {
         var shape = $Graphics$Collage.square(smallSize - 6);
         return $Graphics$Collage.rotate($Basics.degrees(45))($Graphics$Collage.group(_L.fromArray([$Graphics$Collage.filled(col)(shape)
                                                                                                   ,$Graphics$Collage.outlined($Graphics$Collage.defaultLine)(shape)])));
      }();
   };
   var renderBoard = F2(function (shiftProgress,
   board) {
      return function () {
         var isShiftAnimation = !_U.eq(shiftProgress,
         $Maybe.Nothing);
         var shiftFactor = $Maybe.withDefault(0)(A2($Maybe.map,
         $Basics.snd,
         shiftProgress));
         var shiftCmd = $Maybe.withDefault({_: {}
                                           ,index: -1
                                           ,side: $Game.North})(A2($Maybe.map,
         $Basics.fst,
         shiftProgress));
         var shiftOff = function () {
            var _v18 = shiftCmd.side;
            switch (_v18.ctor)
            {case "East":
               return {ctor: "_Tuple2"
                      ,_0: (0 - shiftFactor) * pieceSize
                      ,_1: 0};
               case "North":
               return {ctor: "_Tuple2"
                      ,_0: 0
                      ,_1: (0 - shiftFactor) * pieceSize};
               case "South":
               return {ctor: "_Tuple2"
                      ,_0: 0
                      ,_1: shiftFactor * pieceSize};
               case "West":
               return {ctor: "_Tuple2"
         ...
         var isShifted = function (_v19) {
            return function () {
               switch (_v19.ctor)
               {case "_Tuple2":
                  return $Game.isHorizontal(shiftCmd.side) && _U.eq(shiftCmd.index,
         ...
         var shiftAnim = function (pos) {
            return $Graphics$Collage.move(isShifted(pos) ? shiftOff : {ctor: "_Tuple2"
                                                                      ,_0: 0
                                                                      ,_1: 0});
         };
         var freePiecePos = function () {
            var _v23 = shiftCmd.side;
            switch (_v23.ctor)
            {case "East":
               return {ctor: "_Tuple2"
                      ,_0: board.width
         ...
         var renderGroundAt = function (pos) {
            return function () {
               ...
               switch (_v24.ctor)
               {case "Just":
                  return _L.fromArray([shiftAnim(pos)($Graphics$Collage.move(b2c(pos))(A2(renderPiece,
                    $Game.cellMovable(pos),
                    _v24._0)))]);
                  case "Nothing":
                  return _L.fromArray([]);}
               _U.badCase($moduleName,
         ...
         var renderTreasureAt = function (pos) {
            return function () {
               var _v26 = A2($Dict.get,
               pos,
               board.pieces);
               switch (_v26.ctor)
               {case "Just":
                  return $Util.maybeToList($Maybe.map(function ($) {
                       return shiftAnim(pos)($Graphics$Collage.move(b2c(pos))($));
                    })($Maybe.map(renderTreasure)(A2($Maybe.andThen,
                    _v26._0.treasure,
                    function (tr) {
                       return A2($Set.member,
                       tr,
                       board.collectedTreasures) ? $Maybe.Nothing : $Maybe.Just(tr);
                    }))));
                  case "Nothing":
                  return _L.fromArray([]);}
               _U.badCase($moduleName,
         ...
         _L.range(0,board.width - 1),
         _L.range(0,board.height - 1)));
         var freePieceAnimated = shiftAnim(freePiecePos)($Graphics$Collage.move(b2c(freePiecePos))($Graphics$Collage.group(A2($List._op["::"],
         A2(renderPiece,
         true,
         board.freePiece),
         $Util.maybeToList(A2($Maybe.map,
         renderTreasure,
         board.freePiece.treasure))))));
         var pieces = A2($Basics._op["++"],
         isShiftAnimation ? _L.fromArray([freePieceAnimated]) : _L.fromArray([]),
         $List.concatMap(renderGroundAt)(A2($Util.cartProd,
         _L.range(0,board.width - 1),
         _L.range(0,board.height - 1))));
         var homes = A2($List.map,
         function (p) {
            return $Graphics$Collage.move(b2c(p.home))(renderHome(p.color));
         },
         board.players);
         var tokens = A2($List.map,
         function (p) {
            return shiftAnim(p.position)($Graphics$Collage.move(b2c(p.position))(playerToken(p.color)));
         },
         $List.reverse(board.players));
         return $Graphics$Collage.group(A2($Basics._op["++"],
         pieces,
         A2($Basics._op["++"],
         homes,
   ...
   var shiftButtonArrow = F2(function (side,
   color) {
      return function () {
         var shape = A2($Graphics$Collage.ngon,
         3,
         smallSize);
         return A2($Graphics$Collage.collage,
         pieceSize,
         pieceSize)($Util.singleton($Graphics$Collage.rotate(0 - $Game.orientationAngle(side))($Graphics$Collage.rotate($Basics.degrees(270))($Graphics$Collage.group(_L.fromArray([$Graphics$Collage.filled(color)(shape)
                                                                                                                                                                                   ,$Graphics$Collage.outlined($Graphics$Collage.defaultLine)(shape)]))))));
      }();
   });
   var Moving = {ctor: "Moving"};
   var Shifting = F2(function (a,
   b) {
      return {ctor: "Shifting"
             ,_0: a
             ,_1: b};
   });
   var WaitForShift = {ctor: "WaitForShift"};
   var viewFreePiece = F2(function (turnState,
   piece) {
      return function () {
         var isShifting = function () {
            switch (turnState.ctor)
            {case "Shifting": return true;}
            return false;
         }();
         var isShiftState = _U.eq(turnState,
         WaitForShift);
         var rotateButton = function (dir) {
            return isShiftState ? $Graphics$Input.clickable(A2($Signal.send,
            freeRotateChannel,
            dir))(A2(rotateButtonArrow,
            dir,
            true)) : A2(rotateButtonArrow,
            dir,
            false);
         };
         var controls = A2($Graphics$Element.flow,
         $Graphics$Element.right,
         _L.fromArray([rotateButton($Game.CCW)
                      ,isShifting ? A2($Graphics$Element.spacer,
                      pieceSize,
                      pieceSize) : A3($Graphics$Collage.collage,
                      pieceSize,
                      pieceSize,
                      _L.fromArray([A2(renderPiece,
                                   true,
                                   piece)
                                   ,$Graphics$Collage.group($Util.maybeToList(A2($Maybe.map,
                                   renderTreasure,
                                   piece.treasure)))]))
                      ,rotateButton($Game.CW)]));
         return controls;
      }();
   });
   var viewInGame = F2(function (turnState,
   board) {
      return function () {
         var shiftProgress = function () {
            switch (turnState.ctor)
            {case "Shifting":
         ...
         var turnStateInfo = function () {
            ...
            {case "Moving":
               ...
               case "Shifting":
               return $Text.plainText("Shifting...");
               case "WaitForShift":
               return $Text.plainText(A2($Basics._op["++"],
         ...
         _L.fromArray([A2($Graphics$Element.spacer,
                      0,
                      100)
                      ,$Text.leftAligned($Text.height(20)($Text.bold($Text.fromString("Players"))))
                      ,viewPlayerList(board.players)
                      ,A2($Graphics$Element.spacer,
                      0,
                      100)
                      ,$Text.leftAligned($Text.height(20)($Text.bold($Text.fromString("Piece to shift in"))))
                      ,A2(viewFreePiece,
                      turnState,
                      board.freePiece)
                      ,A2($Graphics$Element.spacer,
                      0,
                      100)
                      ,$Text.leftAligned($Text.height(20)($Text.bold($Text.fromString("Instructions"))))
                      ,turnStateInfo]));
         var bsize = boardRealSize(board);
         var buttonPos = F2(function (side,
         idx) {
            return function () {
               switch (side.ctor)
               {case "East":
                  return A2(boardToCanvas,
                    board,
                    {ctor: "_Tuple2"
                    ,_0: board.width
                    ,_1: idx});
         ...
         idx) {
            return $Graphics$Collage.move(A2(buttonPos,
            side,
            idx))($Graphics$Collage.toForm(_U.eq($Maybe.Just({_: {}
                                                             ,index: idx
                                                             ,side: $Game.opposite(side)}),
            board.lastShift) || !_U.eq(turnState,
            WaitForShift) ? A2(shiftButtonArrow,
            side,
            $Color.grey) : $Graphics$Input.clickable(A2($Signal.send,
            shiftChannel,
            {_: {}
            ,index: idx
            ,side: side}))(A2(shiftButtonArrow,
            side,
            $Color.yellow))));
         });
         var shiftButtonSpec = _L.fromArray([{ctor: "_Tuple2"
                                             ,_0: $Game.North
                                             ,_1: $Game.movableCols(board)}
                                            ,{ctor: "_Tuple2"
                                             ,_0: $Game.South
                                             ,_1: $Game.movableCols(board)}
                                            ,{ctor: "_Tuple2"
                                             ,_0: $Game.West
                                             ,_1: $Game.movableRows(board)}
                                            ,{ctor: "_Tuple2"
                                             ,_0: $Game.East
                                             ,_1: $Game.movableRows(board)}]);
         var shiftButtons = A2($List.concatMap,
         function (_v38) {
            return function () {
               switch (_v38.ctor)
               {case "_Tuple2":
         ...
         shiftButtonSpec);
         var boardElement = A2($Graphics$Collage.collage,
         bsize.width + pieceSize * 2,
         bsize.height + pieceSize * 2)(A2($Basics._op["++"],
         _L.fromArray([A2(renderBoard,
         shiftProgress,
         board)]),
         shiftButtons));
         var content = A2($Graphics$Element.beside,
         $Util.makeUnselectable(boardElement),
         infoElement);
         return content;
      }();
   });
   var viewMain = function (scene) {
      return function () {
         switch (scene.ctor)
         {case "AskPlayerNames":
            return viewAskPlayerNames(scene._0);
            case "GameOver":
            return viewGameOver(scene._0);
            case "InGame":
            return A2(viewInGame,
              scene._0,
              scene._1);}
         _U.badCase($moduleName,
   ...
   var testGameOverState = GameOver(A2($List.sortBy,
   $Game.rank,
   _L.fromArray([{_: {}
                 ,color: $Color.blue
                 ,home: {ctor: "_Tuple2"
                ...
                ,{_: {}
                 ...
                 ,position: {ctor: "_Tuple2"
                            ...
                            ,_1: 0}
                 ,targets: _L.fromArray([])}])));
   var InGame = F2(function (a,b) {
      return {ctor: "InGame"
             ,_0: a
             ,_1: b};
   });
   var AskPlayerNames = function (a) {
      return {ctor: "AskPlayerNames"
             ,_0: a};
   };
   var initialState = AskPlayerNames(A2($List.repeat,
   4,
      ...
      return function () {
         ...
         {case "AskPlayerNames":
            return function () {
                 ...
                 {case "StartGame":
                    return function () {
                         var players = extractPlayerNames(scene._0);
                         return _U.cmp($List.length(players),
                         2) > -1 ? InGame(WaitForShift)($Basics.fst(A2($Game.newGame,
                         $Random.initialSeed($Basics.floor($Time.inMilliseconds(event._0))),
                         players))) : AskPlayerNames(scene._0);
                      }();
                    case "UpdatePlayerNames":
                    return AskPlayerNames(event._0);}
                 return scene;
              }();
            case "GameOver":
            return function () {
                 switch (event.ctor)
                 {case "RestartWithNewPlayers":
                    return initialState;
                    case "RestartWithSamePlayers":
                    return InGame(WaitForShift)($Basics.fst(A2($Game.newGame,
                      $Random.initialSeed($Basics.floor($Time.inMilliseconds(event._0))),
                      A2($List.map,
                      function (_) {
                         return _.name;
                      ...
                      scene._0))));}
                 return GameOver(scene._0);
              }();
            case "InGame":
            return function () {
                 switch (scene._0.ctor)
                 {case "Moving":
                    return function () {
                         switch (event.ctor)
                         {case "EndTurn":
                            return function () {
                                 var afterTargetCheck = $Game.processTarget(scene._1);
                                 return $Game.hasWon($Game.currentPlayer(afterTargetCheck)) ? GameOver(A2($List.sortBy,
                                 $Game.rank,
                                 afterTargetCheck.players)) : A2(InGame,
                                 WaitForShift,
                                 $Game.nextPlayer(afterTargetCheck));
                              }();
                            case "MoveToken":
                            return A2(InGame,
                              Moving,
                    ...
                    return function () {
                         ...
                         {case "ShiftAnimation":
                            return function () {
                                 var progress$ = scene._0._1 + $Time.inSeconds(event._0);
                                 return _U.cmp(progress$,
                                 1) > -1 ? A2(InGame,
                                 Moving,
                                 A2($Game.shift,
                                 scene._0._0,
                    ...
                    return function () {
                         switch (event.ctor)
                         {case "RotateFreePiece":
                            return A2(InGame,
                              WaitForShift,
                              A2($Game.rotateFreePiece,
                              event._0,
                              scene._1));
                            case "ShiftRow":
                            return A2(InGame,
                              A2(Shifting,event._0,0),
                              scene._1);}
                         return scene;
                      }();}
                 _U.badCase($moduleName,
   ...
   var runGame = function ($) {
      return $Signal.dropRepeats(A2($Signal.foldp,
      stepGame,
      initialState)($));
   };
   var ShiftAnimation = function (a) {
      return {ctor: "ShiftAnimation"
             ,_0: a};
   };
   var RestartWithNewPlayers = {ctor: "RestartWithNewPlayers"};
   var RestartWithSamePlayers = function (a) {
      return {ctor: "RestartWithSamePlayers"
             ,_0: a};
   };
   var EndTurn = {ctor: "EndTurn"};
   var MoveToken = function (a) {
      return {ctor: "MoveToken"
             ,_0: a};
   };
   var ShiftRow = function (a) {
      return {ctor: "ShiftRow"
             ,_0: a};
   };
   var RotateFreePiece = function (a) {
      return {ctor: "RotateFreePiece"
             ,_0: a};
   };
   var UpdatePlayerNames = function (a) {
      return {ctor: "UpdatePlayerNames"
             ,_0: a};
   };
   ...
   var collectEvents = $Signal.mergeMany(_L.fromArray([A2($Signal._op["<~"],
                                                      function ($) {
                                                         return StartGame($Basics.fst($));
                                                      },
                                                      $Time.timestamp($Signal.subscribe(startGameChannel)))
                                                      ,A2($Signal._op["<~"],
                                                      UpdatePlayerNames,
                                                      $Util.subscribeMany(playerNameChannels))
                                                      ,A2($Signal._op["<~"],
                                                      RotateFreePiece,
                                                      $Signal.subscribe(freeRotateChannel))
                                                      ,A2($Signal._op["<~"],
                                                      ShiftRow,
                                                      $Signal.subscribe(shiftChannel))
                                                      ,A2($Signal._op["<~"],
                                                      MoveToken,
                                                      moveCommands)
                                                      ,A2($Signal._op["<~"],
                                                      $Basics.always(EndTurn),
                                                      $Util.keyPresses(function (_) {
                                                         return _.keyCode;
                                                      }($Keyboard$Keys.enter)))
                                                      ,A2($Signal._op["<~"],
                                                      $Basics.always(RestartWithNewPlayers),
                                                      $Signal.subscribe(restartNewChannel))
                                                      ,A2($Signal._op["<~"],
                                                      function ($) {
                                                         return RestartWithSamePlayers($Basics.fst($));
                                                      },
                                                      $Time.timestamp($Signal.subscribe(restartSameChannel)))
                                                      ,A2($Signal._op["<~"],
                                                      ShiftAnimation,
                                                      $Time.fps(30))]));
   var main = A2($Signal._op["<~"],
   viewMain,
   runGame(collectEvents));
   _elm.Main.values = {_op: _op
                      ...
                      ,InGame: InGame
                      ,GameOver: GameOver
                      ,WaitForShift: WaitForShift
                      ,Shifting: Shifting
                      ,Moving: Moving
                      ,smallSize: smallSize
                      ,pieceSize: pieceSize
                      ,boardRealSize: boardRealSize
                      ,renderTreasure: renderTreasure
                      ,renderPiece: renderPiece
                      ,boardToCanvas: boardToCanvas
                      ,renderHome: renderHome
                      ,playerToken: playerToken
                      ,shiftButtonArrow: shiftButtonArrow
                      ,rotateButtonArrow: rotateButtonArrow
                      ,renderBoard: renderBoard
                      ,colorIndicator: colorIndicator
                      ,viewPlayerList: viewPlayerList
                      ,viewFreePiece: viewFreePiece
                      ,viewInGame: viewInGame
                      ,viewAskPlayerNames: viewAskPlayerNames
                      ,viewGameOver: viewGameOver
                      ,viewMain: viewMain
                      ,shiftChannel: shiftChannel
                      ,freeRotateChannel: freeRotateChannel
                      ,startGameChannel: startGameChannel
                      ,restartSameChannel: restartSameChannel
                      ,restartNewChannel: restartNewChannel
                      ,playerNameChannels: playerNameChannels
                      ,moveCommands: moveCommands
                      ,collectEvents: collectEvents
                      ,extractPlayerNames: extractPlayerNames
                      ,stepGame: stepGame
                      ,initialState: initialState
                      ,testGameOverState: testGameOverState
                      ,runGame: runGame
                      ,main: main};
   return _elm.Main.values;
};
...
Elm.Util.make = function (_elm) {
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var withClass = F2(function ($class,
   el) {
      return function () {
   ...
   var unselectable = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
   ...
   var subscribeMany = traverse($Signal.subscribe);
   ...
   var ap = F2(function (fs,xs) {
      return A2($List.concatMap,
      A2($Basics.flip,$List.map,xs),
      fs);
   });
   var cartProd = F2(function (x,
   y) {
      return A2(ap,
      A2($List.map,
      F2(function (v0,v1) {
   ...
   var unsafeGet = function (key) {
      return function ($) {
         return $List.head(maybeToList($Dict.get(key)($)));
      };
   };
   var keyPresses = function (key) {
      return A2($Signal._op["<~"],
